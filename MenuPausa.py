...
def Pausa():
   ...
   screen = pygame.display.set_mode((1200, 727), pygame.FULLSCREEN)

   # Set the window caption
   pygame.display.set_caption("Menu Example - (c) Scott Barlow")

   #Ingresa la musica
   pygame.mixer.music.load("Musica/MenuPausa.mp3")
   ...
   bkg = load_image('MenuPause2.jpg', 'images')
   ...
   while 1:
      ...
      if e.type == pygame.KEYDOWN or e.type == EVENT_CHANGE_STATE:
         if state == 0:
            ...
            pygame.mixer.music.load("Musica/Hall.mp3")
            pygame.mixer.music.play(-1)            
            return
